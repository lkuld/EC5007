...
***I have loaded the following packages into this tutorial: EC5007, stringr, dplyr, and ggplot2.***
...
Press run below to show the first observations (rows). 
...
The package `viridis` offers colour combination that help, for instance, to differentiate colours for people with colour blindness or if printed black and white. 
...
The difference between cities is difficult to see. Can you improve the plot? You can see the parameters in the help file (`?geom_histogram`)? Or would you rather use a different type of plot?
